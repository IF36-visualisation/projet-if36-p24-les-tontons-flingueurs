...
Nous pouvons réduire rendre les graphiques moins spacieux et rendre les informations qui nous intéressent plus lisibles avec un graphe Shiny :
![](images/Screenshot_2024-06-24-01-31-35_1920x1080.png)
...
On peut ici aussi créer un graphe interractif pour se focaliser sur les informations qui nous intéressent. On pourrait par exemple ne pas vouloir se limiter à 10h d'écoute au maximum, ou vouloir moins de couleurs différentes en arrondissant plus les valeurs des troubles.
![](images/Screenshot_2024-06-24-01-38-18_1920x1080.png)
...
### 9) Y a-t-il des différences notables dans les scores de troubles mentaux ou les heures d'écoute par jour en fonction de la plateforme de streaming principale utilisée ?
