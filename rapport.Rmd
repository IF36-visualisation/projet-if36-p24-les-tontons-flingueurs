...
Cependant, il serait nécessaire d'approfondir notre sujet pour réellement tirer des conclusions. D’une part, il faudrait essayer de récolter plusieurs milliers de réponses avec une meilleure représentation (différentes cultures, âges, etc...). D’autre part, les réponses portant sur un sujet très sensible et étant auto-déclarées, il serait bien de réaliser une étude sociologique plus rigoureuse et scientifique avec des protocoles stricts.
